...
import 'package:music_app/view/playing_screen/player_widgets.dart';
...
class _NowPlayingState extends State<NowPlaying> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: isDark ? Colors.grey[900] : AppColors.grey300,
      body: SafeArea(
              ...
              Padding(
                ...
                child: SpecialButton(
                  childIcon: Slider(
                    ...
                    onChanged: (value) {
                      Provider.of<NowPlayingController>(context, listen: false)
                          .changeSlider(value);
                    },
                  ),
                ),
